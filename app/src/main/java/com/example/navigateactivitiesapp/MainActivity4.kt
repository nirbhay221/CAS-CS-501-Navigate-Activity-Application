...
class MainActivity4 : AppCompatActivity(),GestureDetector.OnGestureListener,SensorEventListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
            setContentView(R.layout.activity_main4_landscape)
        } else {
            setContentView(R.layout.activity_main4)
        }
        gestureDetector = GestureDetector(this,this)

        imageViewed =findViewById<ImageView>(R.id.imageView4)
            ...
            1 -> {
                ...
                if(abs(valueY)> MIN_DISTANCE){
                    if(y2>y1){
                        ...
                        Toast.makeText(this,"We can't go further up.",Toast.LENGTH_LONG).show()
                    }
                }
            }
